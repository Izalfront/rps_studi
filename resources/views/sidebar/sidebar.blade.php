        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu {{set_active(['student/list','student/grid','student/add/page'])}} {{ (request()->is('student/edit/*')) ? 'active' : '' }} {{ (request()->is('student/profile/*')) ? 'active' : '' }}">
                    ...
                    <ul>
                        <!--<li><a href="{{ route('student/list') }}" class="{{set_active(['student/list','student/grid'])}}">Dashboard Admin</a></li>-->
                ...
                <li class="submenu  {{set_active(['teacher/add/page','teacher/list/page','teacher/edit'])}} {{ (request()->is('teacher/edit/*')) ? 'active' : '' }}">
                    ...
                    <ul>
                        ...
                        <!--<li><a class="{{ (request()->is('teacher/edit/*')) ? 'active' : '' }}">Edit Pengajar</a></li>-->
                    </ul>
                </li>
                <li class="submenu {{set_active(['department/add/page','department/edit/page'])}}">
                    ...
                    <ul>
                        <!--<li><a href="departments.html">Dashboard kajur</a></li>-->
